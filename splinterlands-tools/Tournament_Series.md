...
## Using the Page
- Launch the app: `streamlit run app.py`, open “Tournament Series”.
...
## Saved Configs
- Stored in Supabase `series_configs` with fields: name, organizer, point_scheme, include_ids, exclude_ids, include_after, include_before, visibility, note.
- Selecting a config applies its point scheme and filters to the page; current UI is read-only for configs (create/update via Supabase or scripts).
