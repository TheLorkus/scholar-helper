...
def main() -> None:
    page = st.sidebar.radio("Page", ["Brawl Assistant", "Scholar rewards"], index=0)
    if page == "Brawl Assistant":
        render_brawl_assistant()
    else:
        render_scholar_tracker()
